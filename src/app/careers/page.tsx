...
const Careers: React.FC = () => {
          ...
          <div className="space-y-8">
            ...
            <form className="space-y-6">
              ...
              <div className="flex justify-center items-center">
                <motion.button
                  type="submit"
                  className="w-1/2 bg-orange-500 text-white py-2 px-4 rounded-md hover:bg-orange-700 transition"
  ...
  return (
    <div>
      <NavBar/>
      <div className="bg-gradient-to-b from-gray-900 to-blue-800 min-h-screen py-10 text-white xl:pt-20 pt-12 pb-12">
        <div className="container mx-auto px-4 py-12">
          ...
          >
            <h1 className="xl:text-5xl text-4xl font-bold mb-4 bg-gradient-to-r from-white to-indigo-300 text-transparent bg-clip-text">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-6">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white/10 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 text-white placeholder-gray-400"
                  value={searchTerm}
          ...
          >
            {filteredJobs.length > 0 ? (
              filteredJobs.map((job, index) => (
                <motion.div
                  key={index}
                  className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover:border-indigo-500/50 transition-all duration-300"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <h2 className="text-xl font-semibold mb-2 text-white group-hover:text-indigo-400 transition-colors">
                    {job.title}
                  </h2>
                  <p className="text-indigo-300 mb-4">{job.department}</p>
                  ...
                  {/* Apply Button */}
                  <motion.button
                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => {
                      setSelectedJob(job);
