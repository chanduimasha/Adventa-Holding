...
//   const jobs = [
//     {
//       topic: "Associate Engineer (L1) IT Support",
//       location: "Islandwide",
//       type: "On-site",
...
//     },
//     {
//       topic: "Software Developer (Frontend)",
//       location: "Colombo",
//       type: "Hybrid",
//       employment: "Full Time",
//       experience: "3 years",
...
//   const JobModal: React.FC<{ job: Job; onClose: () => void }> = ({ job, onClose }) => (
//     <motion.div
//       className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4"
//       initial={{ opacity: 0 }}
//       animate={{ opacity: 1 }}
...
//                 animate={{ opacity: 1 }}
//               >
//                 <div className="text-gray-700 dark:text-gray-300 text-lg mb-4">No jobs found</div>
