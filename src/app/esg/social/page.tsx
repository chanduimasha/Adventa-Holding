    ...
    <div>
      ...
      <div className="min-h-screen bg-blue-50 dark:bg-neutral-900 p-8 xl:pt-32 pt-24 pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-xl p-8 dark:border dark:border-gray-800 dark:hover:shadow-blue-lg">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-gray-600 dark:text-gray-400">Community Programs</span>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-gray-600 dark:text-gray-400">Training Hours</span>
            ...
            <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-xl p-8 dark:border dark:border-gray-800 dark:hover:shadow-blue-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-gray-200">10,000+</h3>
                    <p className="text-gray-600 dark:text-gray-400">Employees Trained</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-gray-200">50+</h3>
                    <p className="text-gray-600 dark:text-gray-400">Community Partners</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-gray-200">25+</h3>
                    <p className="text-gray-600 dark:text-gray-400">Educational Programs</p>
                  </div>
                </div>
              </div>
            </div>
