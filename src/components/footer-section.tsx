      ...
      <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-4 gap-8 pb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-orange-500">
            Aventa<span className="text-white"> Holdings</span>
          </h1>
          ...
          <div>
            <Social
              ...
              iconStyles="xl:w-[30px] xl:h-[30px] w-9 h-9 border border-orange-100 rounded-full flex justify-center items-center bg-orange-500 text-orange-100 text-base hover:bg-orange-800 hover:text-primary hover:transition-all duration-500"
            />
          </div>
        </div>
        ...
        {/* Services Section */}
        <div>
          <h2 className="text-lg font-semibold text-orange-500">Services</h2>
        ...
        {/* Information Section */}
        <div>
          <h2 className="text-lg font-semibold text-orange-500">Information</h2>
          <ul className="mt-4 space-y-2">
            <li className="hover:text-orange-500 transition-colors">
        ...
        {/* Contact Section */}
        <div>
          <h2 className="text-lg font-semibold text-orange-500">Contacts</h2>
          <div className="flex-1 flex items-center xl:justify-end order-1 xl:order-none mb-8 xl:mb-0 mt-5">
            <ul className="flex flex-col gap-5">
              {info.map((item, index) => (
                <li key={index} className="flex items-center gap-4">
                  <div className="w-[32px] h-[32px] xl:w-[38px] xl:h-[38px] bg-[#27272c] text-orange-500 rounded-md flex items-center justify-center">
          ...
          <div className="mt-4 flex items-center gap-1">
            ...
            <button className="flex items-center gap-2 px-[14px] py-[14px] bg-orange-500 text-white text-base font-semibold rounded-md hover:bg-orange-600 transition-all duration-300">
              <FaBell className="text-lg " />
            </button>
          </div>
        </div>
      </div>
      <hr className="border-t-2 border-orange-500 my-6 mx-auto w-4/5" />
