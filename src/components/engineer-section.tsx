  ...
  return (
    <section className="relative text-white py-28 px-6 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          <h1 className="xl:text-8xl text-4xl font-bold mb-16">We Engineer</h1>
          <p className="xl:text-xl text-lg mt-2 px-2 xl:px-48 text-center pb-20">
            Streamline your software engineering to drive greater efficiency and
            enable resiliency across your products and platforms.
          </p>
        </motion.div>
