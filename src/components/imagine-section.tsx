  ...
  return (
    <section className="relative text-white py-28 px-6 overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/assets/achievements/1.jpeg')" }}
      ></div>
      ...
      <div className="relative z-10">
        ...
        >
          <h1 className="xl:text-8xl text-4xl font-bold mb-16">We Imagine</h1>
          <p className="xl:text-xl text-lg mt-2 px-2 xl:px-48 text-center pb-20">
            ...
            business models to meet rising customer expectations and accelerate
            your growth.
          </p>
        </motion.div>
